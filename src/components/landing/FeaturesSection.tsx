...
export const FeaturesSection = () => {
  ...
  return <section className="py-16 px-4 bg-[#2C2C2C]">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-[#F5E9D7] text-3xl font-montserrat font-bold text-center mb-12">Une application spécialisé pour chaque style de pizza</h2>
        
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <Card className="bg-slate-700 border-[#77BFA3] overflow-hidden">
            <div className="h-48 overflow-hidden">
              <img src={getImageUrl(0, 'napolitaine')} alt="Pizza Napolitaine" className="w-full h-full object-cover" />
            </div>
          ...
          <Card className="bg-slate-700 border-[#C53030] overflow-hidden">
            <div className="h-48 overflow-hidden">
              <img src={getImageUrl(1, 'teglia')} alt="Pizza Teglia Romaine" className="w-full h-full object-cover" />
            </div>
            <CardContent className="p-6">

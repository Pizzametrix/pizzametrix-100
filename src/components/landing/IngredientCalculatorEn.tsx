  ...
  useEffect(() => {
    const loadCalculatorImages = async () => {
      try {
        ...
        console.error("Error loading calculator images:", error);
      } finally {
        setIsLoading(false);
      }
    };
    ...
    <section className="py-16 px-4 bg-slate-800" id="calculator">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-[#F5E9D7] text-3xl font-montserrat font-bold text-center mb-8">
          Perfectly calculate all your ingredients
        </h2>
          ...
          <div className="flex flex-col gap-4 md:col-span-2">
            ...
            >
              <div className={`flex items-center gap-3 p-4 ${
                ...
                <h3 className="text-xl font-montserrat font-bold mb-0">Water, salt, oil, sugar</h3>
              </div>
              <p className={`mt-0 pb-4 pl-4 pr-4 text-left ${
                selectedIngredient === 'eau' ? 'text-white/90' : 'text-[#F5E9D7]/80'
              }`}>
                Precisely calculate the quantities of liquids and additives for perfect hydration.
              </p>
            </button>
            ...
            >
              <div className={`flex items-center gap-3 p-4 ${
                ...
                <h3 className="text-xl font-montserrat font-bold mb-0">Precise yeast quantity</h3>
              </div>
              <p className={`mt-0 pb-4 pl-4 pr-4 text-left ${
                selectedIngredient === 'levure' ? 'text-white/90' : 'text-[#F5E9D7]/80'
              }`}>
                Get the exact amount of yeast according to your fermentation time and ambient temperature.
              </p>
            </button>
            ...
            >
              <div className={`flex items-center gap-3 p-4 ${
                ...
                <h3 className="text-xl font-montserrat font-bold mb-0">Add resting periods</h3>
              </div>
              <p className={`mt-0 pb-4 pl-4 pr-4 text-left ${
                selectedIngredient === 'repos' ? 'text-white/90' : 'text-[#F5E9D7]/80'
              }`}>
                Plan each fermentation stage to develop optimal flavors and structure in your dough.
              </p>
            </button>
            ...
            >
              <div className={`flex items-center gap-3 p-4 ${
                ...
                <h3 className="text-xl font-montserrat font-bold mb-0 text-left">Manage your Biga or Poolish pre-ferments</h3>
              </div>
              <p className={`mt-0 pb-4 pl-4 pr-4 text-left ${
                selectedIngredient === 'preempattement' ? 'text-white/90' : 'text-[#F5E9D7]/80'
              }`}>
                Enhance the complexity and digestibility of your dough with precise pre-fermentation calculations.
              </p>
            </button>
          </div>
          ...
          <div className="bg-slate-700 rounded-lg overflow-hidden h-full flex items-center justify-center">
            {selectedIngredient && ingredientImages[selectedIngredient] ? (
              <img 
                ...
                alt={`Function ${selectedIngredient}`} 
              ...
              <div className="text-[#F5E9D7]/60 text-lg">
                Select a feature to see more information
              </div>
            )}
          </div>
        </div>

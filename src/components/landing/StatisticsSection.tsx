...
export const StatisticsSection = () => {
  ...
  return <section ref={sectionRef} className="py-16 px-4 bg-texture-dark">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="flex flex-col items-center p-6 rounded-lg bg-gradient-dark animate-on-scroll" style={{

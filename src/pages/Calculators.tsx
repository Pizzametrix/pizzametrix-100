...
export default function Calculators() {
  ...
  return <div className="min-h-screen flex bg-slate">
      <Sidebar />
        ...
        <div className="md:pl-64">
          <main className="w-full max-w-4xl mx-auto p-4 md:p-8 mt-16 md:mt-0">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <Card className="bg-slate border-cream/10 cursor-pointer transition-transform hover:scale-105" onClick={() => navigate('/calculators/napolitaine')}>
                <CardHeader>
              ...
              <Card className="bg-slate border-cream/10 cursor-pointer transition-transform hover:scale-105" onClick={() => navigate('/calculators/teglia')}>
                <CardHeader>

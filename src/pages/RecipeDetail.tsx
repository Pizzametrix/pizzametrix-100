...
export default function RecipeDetail() {
  ...
  return (
    <div className="min-h-screen bg-slate">
      <div className="fixed top-0 left-0 right-0 z-50 h-16 bg-slate border-b border-cream/10 flex items-center px-4">
        <h1 className="text-cream text-lg font-medium">{recipe.nom}</h1>
      </div>

      <main className="mt-20 p-4 pb-24 space-y-6 max-w-2xl mx-auto">

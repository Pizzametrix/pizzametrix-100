            ...
            <>
              <div className="absolute w-full top-6 z-50 flex justify-between px-8">
                <Button
                  ...
                  className="bg-slate/80 text-cream hover:text-terracotta hover:bg-slate ml-8 my-[5px] mx-0"
                >
                ...
                <Button
                  ...
                  size="icon"
                  onClick={onClose}
                  className="bg-slate/80 text-cream hover:text-terracotta hover:bg-slate mr-8 my-[5px] mx-[2px]"
                >
                  <X className="h-6 w-6" />
                </Button>
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <Button
                  variant="ghost"
                  size="icon"
                  className="absolute right-16 top-1/2 -translate-y-1/2 z-50 bg-slate/80 text-cream hover:text-terracotta hover:bg-slate"
                  onClick={showNext}
